...
version_added: "0.1.0"
short_description: Get facts for Azure SqlServer
description:
    - Get facts for a specific SqlServer or list all SqlServers in a resource group.
...
options:
    ...
    name:
        description:
            ...
            - If not specified, all sqlservers in the resource group will be listed.
        type: str
...
EXAMPLES = r'''
- name: Get facts for a specific SqlServer
  azure_rm_sqlserver_info:
    resource_group: myResourceGroup
    name: mySqlServer

- name: List all SqlServers in a resource group
  azure_rm_sqlserver_info:
    resource_group: myResourceGroup
'''
