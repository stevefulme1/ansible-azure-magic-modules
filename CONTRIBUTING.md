# Contributing to ansible-azure-magic-modules

Thank you for your interest in contributing to **ansible-azure-magic-modules**!
...
```bash
git clone https://github.com/stevefulme1/ansible-azure-magic-modules.git
cd ansible-azure-magic-modules
```
